  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            <h1 className="text-3xl font-bold flex items-center">
              <Bitcoin className="h-7 w-7 mr-2 text-bitcoin" />
              {carteira.nome}
            </h1>
            <p className="text-sm font-mono text-muted-foreground mt-1">{carteira.endereco}</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bitcoin-card p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bitcoin-card p-5 col-span-1">
          <h3 className="text-lg font-semibold mb-4">Saldo atual</h3>
          <p className="text-3xl font-bold bitcoin-gradient-text">{formatarBTC(carteira.saldo)}</p>
        </div>
        
        <div className="bitcoin-card p-5 col-span-1 md:col-span-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="flex items-center">
                ...
                <p>{formatarBTC(carteira.total_entradas)}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <p>{formatarBTC(carteira.total_saidas)}</p>
              </div>
            </div>
          </div>
        </div>
